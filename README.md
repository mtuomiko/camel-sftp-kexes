...
Demo for a possible bug in Camel SFTP where keyExchangeProtocols settings leak between endpoints through Jsch. Uses TestContainers, so requires a container runtime (like Docker).
